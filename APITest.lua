    ...
    -- in the community. This has been a rough time for me, and I never imagined that I would have to go through this. 
    -- I believe that during these times we must double down and put as much effort as possible into making
    ...
    -- my actions looked to others. I've learned so much from this contreversy.0 I'm sorry that what I said was unclear, and subject to misinterpretation. Thanks for staying by my side, and thanks for not being swayed.
    ...
    bedrockUI.scrollBarBuilder:new():computeHandleSize()
    ...
    --bedrockInput.RegisterKeyEvent("TEST NAME", function() --[[originally an error not a print.]] print("Ow.") end, function() term.write("--") end, function() terminate = true end, "`")
    --bedrockInput.RegisterKeyEvent("TEST NAME", function() --[[originally an error not a print.]] print("Ow.") end, function() term.write("--") end, function() terminate = true end, "~")
    term.clear()
    ...
    local object2 = bedrockGraphics.objectBase:new():setText("OBJECTS???"):setPosition(5, 5, 7):setSize(monitor.width - 8, monitor.height / 3):setBackgroundColor(0x00ff00):setTextColor(0x101010)
    ...
    if monitor.generic.isColor() then
        ...
        gayObject:setBackgroundColor(0xacacac)
    end
